mobs:register_mob("mobs_mese:lightmese_monster", {
	type = "monster",
	passive = false,
	docile_by_day = true,
	damage = 8,
	attack_type = "shoot",
	shoot_interval = 0.01,
	arrow = "mobs_mese:lightmese_arrow",
	shoot_offset = 2,
	hp_min = 1000,
	hp_max = 3000,
	armor = 1,
	...
	fly_in = "air",
	drops = {
		{name = "mese:lightmese_crystal", chance = 9, min = 0, max = 2},
		{name = "mese:lightmese_crystal_fragment", chance = 1, min = 0, max = 2},
	},
	water_damage = 0,
	lava_damage = 0,
	light_damage = -1,
	...
	follow = {"mese:lightmese_crystal","mese:lightmese_block","mese:lightmese_crystal_fragment"},
  	on_rightclick = function(self, clicker, pos)
		...
		if mobs:feed_tame(self, clicker, 2, true, true) then
			minetest.add_particlespawner({
				...
				minsize = 0.125,
				maxsize = 0.5,
				texture = "mese_lightmese_crystal.png",
			})
		end
...
mobs:spawn({
	name = "mobs_mese:lightmese_monster",
	nodes = {"default:stone"},
	max_light = 14,
	chance = 8000,
...
--	visual = "wielditem",
	...
	textures = {"mese_lightmese_crystal_fragment.png"},
